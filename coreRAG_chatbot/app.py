...
# from store_index import *
# from sentence_transformers import CrossEncoder
# from langchain.memory import ConversationBufferMemory  #memory để lưu trữ cuộc trò chuyện
...
#     # 1. Lấy context từ Pinecone và rerank bằng CrossEncoder
#     similar_docs = retriever.invoke(user_input)
#     top_docs = rerank_documents(user_input, similar_docs, top_n=5)
#     context_text = "\n\n".join(doc.page_content for doc in top_docs)

#     # 2. Lấy history từ memory
#     history = memory.chat_memory.messages

#     # 3. Tạo prompt mới với lịch sử hội thoại
...
#     # 4. Gọi LLM với prompt và context đã reranked
#     chain = dynamic_prompt | llm
#     answer = chain.invoke({"input": user_input, "context": context_text})
